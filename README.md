...
Test procedures and date from testing can be found in [week 4 documentation](#Week_4_-_November_27_-_December_1st_- ) and [Final Documentation Items](#Blade_Construction)
